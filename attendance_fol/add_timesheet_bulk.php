    ...
    <div class="col-md-12 col-lg-12">
		<div class="page content">
			<div class="page-breadcrumb d-sm-flex align-items-center mb-3">
		        <h5 class="">Add new timesheet record </h5>
		        <div class="ms-auto d-sm-flex">
					<div class="btn-group smr-10">
		                <a type="button" href="<?=baseUri();?>/timesheet"  class="btn btn-secondary">Go back</a>
		            </div>
		        </div>
		    </div>
		    <hr>
			...
			<div class="card">
				<form id="add_bulkTimesheetForm" class="card-body">
                    <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class=" sflex scenter-items">
                                            ...
                                            <div class="sflex scenter-items">
												<input class="form-control time_in time_input cursor" type="time" value="<?=date("H:i:s", strtotime($time_in));?>" style="-width: 100%;" name="">
												<input class="form-control time_in time_input cursor time_out" type="time" value="<?=date("H:i:s", strtotime($time_out));?>" style="-width:  100%;" name="">
											</div>
                                        </div>
                                    </td>
                                </tr>
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        simplifyAddAttendanceTable("Yes");
    });
</script>
